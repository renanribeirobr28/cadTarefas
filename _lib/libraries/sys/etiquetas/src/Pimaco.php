...
class Pimaco
{
    ...
    private function loadConfig()
    {
		...
		$layout = $_SESSION['configEtiqueta'];
		$this->width = $layout['larguraPagina'];
        $this->height = $layout['alturaPagina'];
        $this->fontSize = 10;
        $this->orientation =  "P";
        $this->columns =  "1";//$layout['quantColunas'];
        $this->unit = "mm";
		$this->marginTop =  $layout['margemSuperior'];
        $this->marginLeft = 	$layout['margemEsquerda'];
        $this->marginRight =	$layout['margemDireita'];
        $this->marginBottom = 	$layout['margemInferior'];
        $this->marginHeader = 	$layout['margemHeader'];
        $this->marginFooter = 	$layout['margemFooter'];
		/*

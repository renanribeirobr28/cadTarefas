        ...
        //console.log(type+value);
          ...
          if(type == "theme"){
            if(value != "" && value != defaultval[type]){
              $("link#main-style").attr("href","../_lib/libraries/grp/zak/zak/assets/css/style-"+value+".css");
            } else {
              $("link#main-style").attr("href","../_lib/libraries/grp/zak/zak/assets/css/style.css");
            }
          } else {

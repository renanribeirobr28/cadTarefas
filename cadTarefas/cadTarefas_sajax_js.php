  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cadTarefas" == sTestField)
        {
...
?>
  ...
  // ---------- Validate up_
  function do_ajax_cadTarefas_validate_up_(iNumLinha)
  {
  } // do_ajax_cadTarefas_validate_up_

  function do_ajax_cadTarefas_validate_up__cb(sResp)
  {
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "up_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "up_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cadTarefas_validate_up__cb

  // ---------- Validate down_
  function do_ajax_cadTarefas_validate_down_(iNumLinha)
  {
  } // do_ajax_cadTarefas_validate_down_

  function do_ajax_cadTarefas_validate_down__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "down_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "down_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cadTarefas_validate_down__cb

  // ---------- Validate idtarefa_
  function do_ajax_cadTarefas_validate_idtarefa_(iNumLinha)
  {
    var nomeCampo_idtarefa_ = "idtarefa_" + iNumLinha;
    var var_idtarefa_ = scAjaxGetFieldHidden(nomeCampo_idtarefa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cadTarefas_validate_idtarefa_(var_idtarefa_, iNumLinha, var_script_case_init, do_ajax_cadTarefas_validate_idtarefa__cb);
  } // do_ajax_cadTarefas_validate_idtarefa_

  function do_ajax_cadTarefas_validate_idtarefa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idtarefa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idtarefa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idtarefa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idtarefa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cadTarefas_validate_idtarefa__cb

  // ---------- Validate nome_
  function do_ajax_cadTarefas_validate_nome_(iNumLinha)
  {
    var nomeCampo_nome_ = "nome_" + iNumLinha;
    var var_nome_ = scAjaxGetFieldText(nomeCampo_nome_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cadTarefas_validate_nome_(var_nome_, iNumLinha, var_script_case_init, do_ajax_cadTarefas_validate_nome__cb);
  } // do_ajax_cadTarefas_validate_nome_

  function do_ajax_cadTarefas_validate_nome__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cadTarefas_validate_nome__cb

  // ---------- Validate custo_
  function do_ajax_cadTarefas_validate_custo_(iNumLinha)
  {
    var nomeCampo_custo_ = "custo_" + iNumLinha;
    var var_custo_ = scAjaxGetFieldText(nomeCampo_custo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cadTarefas_validate_custo_(var_custo_, iNumLinha, var_script_case_init, do_ajax_cadTarefas_validate_custo__cb);
  } // do_ajax_cadTarefas_validate_custo_

  function do_ajax_cadTarefas_validate_custo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "custo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "custo_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "custo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "custo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cadTarefas_validate_custo__cb

  // ---------- Validate datalimite_
  function do_ajax_cadTarefas_validate_datalimite_(iNumLinha)
  {
    var nomeCampo_datalimite_ = "datalimite_" + iNumLinha;
    var var_datalimite_ = scAjaxGetFieldText(nomeCampo_datalimite_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cadTarefas_validate_datalimite_(var_datalimite_, iNumLinha, var_script_case_init, do_ajax_cadTarefas_validate_datalimite__cb);
  } // do_ajax_cadTarefas_validate_datalimite_

  function do_ajax_cadTarefas_validate_datalimite__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "datalimite_" + iLineNumber;
    }
    else
    {
      sFieldValid = "datalimite_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "datalimite_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "datalimite_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cadTarefas_validate_datalimite__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_cadTarefas_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_cadTarefas_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_cadTarefas_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_cadTarefas_add_new_line_cb);
  } // do_ajax_cadTarefas_add_new_line

  function do_ajax_cadTarefas_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_cadTarefas_add_new_line_cb

  // ---------- backup_line
  function do_ajax_cadTarefas_backup_line(iNumLinha)
  {
    var var_idtarefa_ = scAjaxGetFieldHidden("idtarefa_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cadTarefas_backup_line(var_idtarefa_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_cadTarefas_backup_line_cb);
  } // do_ajax_cadTarefas_backup_line

  function do_ajax_cadTarefas_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_cadTarefas_backup_line_cb

  function do_ajax_cadTarefas_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_cadTarefas_cancel_insert

  function do_ajax_cadTarefas_cancel_update(iSeqVert)
  {
    do_ajax_cadTarefas_backup_line(iSeqVert);
...
?>
  } // do_ajax_cadTarefas_cancel_update

  function do_ajax_cadTarefas_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_cadTarefas_restore_buttons

  // ---------- table_refresh
  function do_ajax_cadTarefas_table_refresh()
  {
    var var_idtarefa_ = document.F2.idtarefa_.value;
    ...
    scAjaxProcOn();
    x_ajax_cadTarefas_table_refresh(var_idtarefa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cadTarefas_table_refresh_cb);
  } //  do_ajax_cadTarefas_table_refresh

  function do_ajax_cadTarefas_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idtarefa_.value = scAjaxGetKeyValue("idtarefa_");
    ...
    scAjaxAlert(do_ajax_cadTarefas_table_refresh_cb_after_alert);
  } // do_ajax_cadTarefas_table_refresh_cb
  function do_ajax_cadTarefas_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_cadTarefas_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_cadTarefas_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_cadTarefas_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_up_ = scAjaxGetFieldHidden("up_" + iNumLinha);
    var var_down_ = scAjaxGetFieldHidden("down_" + iNumLinha);
    var var_idtarefa_ = scAjaxGetFieldHidden("idtarefa_" + iNumLinha);
    var var_nome_ = scAjaxGetFieldText("nome_" + iNumLinha);
    var var_custo_ = scAjaxGetFieldText("custo_" + iNumLinha);
    var var_datalimite_ = scAjaxGetFieldText("datalimite_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_cadTarefas_submit_form(var_up_, var_down_, var_idtarefa_, var_nome_, var_custo_, var_datalimite_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cadTarefas_submit_form_cb);
  } // do_ajax_cadTarefas_submit_form

  function do_ajax_cadTarefas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("up_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("down_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idtarefa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nome_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("custo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("datalimite_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_cadTarefas_submit_form_cb_after_alert);
  } // do_ajax_cadTarefas_submit_form_cb
  function do_ajax_cadTarefas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cadTarefas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_cadTarefas_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cadTarefas_navigate_form, function() {});
    } else {
      perform_ajax_cadTarefas_navigate_form();
    }
  }

  function perform_ajax_cadTarefas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_cadTarefas_cancel_insert(sc_cadTarefas_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("up_" + iNavForm);
      scAjaxHideErrorDisplay("down_" + iNavForm);
      scAjaxHideErrorDisplay("idtarefa_" + iNavForm);
      scAjaxHideErrorDisplay("nome_" + iNavForm);
      scAjaxHideErrorDisplay("custo_" + iNavForm);
      scAjaxHideErrorDisplay("datalimite_" + iNavForm);
    }
    var var_idtarefa_ = document.F2.idtarefa_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_cadTarefas_navigate_form(var_idtarefa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cadTarefas_navigate_form_cb);
  } // do_ajax_cadTarefas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cadTarefas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cadTarefas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idtarefa_.value = scAjaxGetKeyValue("idtarefa_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cadTarefas_navigate_form_cb_after_alert);
  } // do_ajax_cadTarefas_navigate_form_cb
  function do_ajax_cadTarefas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_cadTarefas_navigate_form_cb_after_alert

    function sc_cadTarefas_get_last_line_number()
    {
    ...
    } //sc_cadTarefas_get_last_line_number

  function sc_hide_cadTarefas_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "up_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "down_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idtarefa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nome_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "custo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "datalimite_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["up_" + iNumLinha] = {"label": "<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["down_" + iNumLinha] = {"label": "<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idtarefa_" + iNumLinha] = {"label": "Identificador<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["custo_" + iNumLinha] = {"label": "Custo R$<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["datalimite_" + iNumLinha] = {"label": "Data Limite<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["up_"][iNumLinha] = "up_" + iNumLinha;
    ajax_field_mult["down_"][iNumLinha] = "down_" + iNumLinha;
    ajax_field_mult["idtarefa_"][iNumLinha] = "idtarefa_" + iNumLinha;
    ajax_field_mult["nome_"][iNumLinha] = "nome_" + iNumLinha;
    ajax_field_mult["custo_"][iNumLinha] = "custo_" + iNumLinha;
    ajax_field_mult["datalimite_"][iNumLinha] = "datalimite_" + iNumLinha;
    ajax_field_id["up_" + iNumLinha] = new Array("hidden_field_label_up_", "hidden_field_data_up_" + iNumLinha);
    ajax_field_id["down_" + iNumLinha] = new Array("hidden_field_label_down_", "hidden_field_data_down_" + iNumLinha);
    ajax_field_id["idtarefa_" + iNumLinha] = new Array("hidden_field_label_idtarefa_", "hidden_field_data_idtarefa_" + iNumLinha);
    ajax_field_id["nome_" + iNumLinha] = new Array("hidden_field_label_nome_", "hidden_field_data_nome_" + iNumLinha);
    ajax_field_id["custo_" + iNumLinha] = new Array("hidden_field_label_custo_", "hidden_field_data_custo_" + iNumLinha);
    ajax_field_id["datalimite_" + iNumLinha] = new Array("hidden_field_label_datalimite_", "hidden_field_data_datalimite_" + iNumLinha);
    ajax_error_count["up_" + iNumLinha] = "off";
    ajax_error_count["down_" + iNumLinha] = "off";
    ajax_error_count["idtarefa_" + iNumLinha] = "off";
    ajax_error_count["nome_" + iNumLinha] = "off";
    ajax_error_count["custo_" + iNumLinha] = "off";
    ajax_error_count["datalimite_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["up_" + iNumLinha] = "off";
    ajax_read_only["down_" + iNumLinha] = "off";
    ajax_read_only["idtarefa_" + iNumLinha] = "on";
    ajax_read_only["nome_" + iNumLinha] = "off";
    ajax_read_only["custo_" + iNumLinha] = "off";
    ajax_read_only["datalimite_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["up_" + iNumLinha] = "on";
    ajax_read_only["down_" + iNumLinha] = "on";
    ajax_read_only["idtarefa_" + iNumLinha] = "on";
    ajax_read_only["nome_" + iNumLinha] = "on";
    ajax_read_only["custo_" + iNumLinha] = "on";
    ajax_read_only["datalimite_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["up_" + iNumLinha] = null;
    ajax_error_list["down_" + iNumLinha] = null;
    ajax_error_list["idtarefa_" + iNumLinha] = null;
    ajax_error_list["nome_" + iNumLinha] = null;
    ajax_error_list["custo_" + iNumLinha] = null;
    ajax_error_list["datalimite_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["up_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["up_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["up_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["up_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["up_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["down_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["down_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["down_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["down_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["down_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idtarefa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idtarefa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idtarefa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idtarefa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idtarefa_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["custo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["custo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["custo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["custo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["custo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["datalimite_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["datalimite_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["datalimite_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["datalimite_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["datalimite_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['up_'])) ? $this->nmgp_cmp_readonly['up_'] : 'off';
?>
    scAjaxFieldRead("up_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['down_'])) ? $this->nmgp_cmp_readonly['down_'] : 'off';
?>
    scAjaxFieldRead("down_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idtarefa_'])) ? $this->nmgp_cmp_readonly['idtarefa_'] : 'on';
?>
    scAjaxFieldRead("idtarefa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['custo_'])) ? $this->nmgp_cmp_readonly['custo_'] : 'off';
?>
    scAjaxFieldRead("custo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['datalimite_'])) ? $this->nmgp_cmp_readonly['datalimite_'] : 'off';
?>
    scAjaxFieldRead("datalimite_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("up_" + iSeq, "on");
    scAjaxFieldRead("down_" + iSeq, "on");
    scAjaxFieldRead("idtarefa_" + iSeq, "on");
    scAjaxFieldRead("nome_" + iSeq, "on");
    scAjaxFieldRead("custo_" + iSeq, "on");
    scAjaxFieldRead("datalimite_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["up_" + iRow] || "on" == ajax_error_count["down_" + iRow] || "on" == ajax_error_count["idtarefa_" + iRow] || "on" == ajax_error_count["nome_" + iRow] || "on" == ajax_error_count["custo_" + iRow] || "on" == ajax_error_count["datalimite_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_up_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_down_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idtarefa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nome_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_custo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_datalimite_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["up_" + iRow] && "off" == ajax_error_count["down_" + iRow] && "off" == ajax_error_count["idtarefa_" + iRow] && "off" == ajax_error_count["nome_" + iRow] && "off" == ajax_error_count["custo_" + iRow] && "off" == ajax_error_count["datalimite_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["up_" + iRow] = "off";
        ajax_error_count["down_" + iRow] = "off";
        ajax_error_count["idtarefa_" + iRow] = "off";
        ajax_error_count["nome_" + iRow] = "off";
        ajax_error_count["custo_" + iRow] = "off";
        ajax_error_count["datalimite_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_up_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_down_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idtarefa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nome_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_custo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_datalimite_" + iRow).removeClass("scFormErrorLine");
    }
  }
